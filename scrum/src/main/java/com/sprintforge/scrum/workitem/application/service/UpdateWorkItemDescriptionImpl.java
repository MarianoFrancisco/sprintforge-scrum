...
import com.sprintforge.scrum.workitem.application.port.in.command.UpdateWorkItemDescription;
import com.sprintforge.scrum.workitem.application.port.in.command.UpdateWorkItemDescriptionCommand;
...
public class UpdateWorkItemDescriptionImpl implements UpdateWorkItemDescription {

    private final FindWorkItemById findWorkItemById;
    private final SaveWorkItem saveWorkItem;

    @Override
    public WorkItem handle(UpdateWorkItemDescriptionCommand command) {
