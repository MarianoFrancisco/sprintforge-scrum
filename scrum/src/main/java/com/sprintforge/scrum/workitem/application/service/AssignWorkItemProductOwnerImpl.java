...
import com.sprintforge.scrum.workitem.application.port.in.command.AssignWorkItemProductOwner;
import com.sprintforge.scrum.workitem.application.port.in.command.AssignWorkItemProductOwnerCommand;
...
public class AssignWorkItemProductOwnerImpl implements AssignWorkItemProductOwner {
    ...
    public WorkItem handle(AssignWorkItemProductOwnerCommand command) {
        ...
        workItem.assignProductOwner(command.productOwnerId());
